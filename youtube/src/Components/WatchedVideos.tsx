...
import { fetchWatchedVideos } from '../Store/WatchSlice';

const WatchVideoHistory = () => {
  const dispatch = useDispatch();
  const watchedVideos = useSelector((state: RootState) => state.watch.videos);
  ...
  if (!watchedVideos || watchedVideos.length === 0) {
    return <div>No watched videos found.</div>;
  }
...
export default WatchVideoHistory;
