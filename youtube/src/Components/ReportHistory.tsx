...
const ReportHistory = ({isSidebarOpen,toggleSidebar}:{isSidebarOpen:boolean;toggleSidebar:boolean}) => {
  ...
  return (
    ...
    <div className="min-h-screen mt-2 bg-[#0f0f0f] text-white p-16">
        ...
        <div className="bg-gray-700 rounded-lg shadow-lg p-6">
          ...
          <div className="overflow-x-auto ">
            <table className="w-full table-auto">
              ...
              <tbody>
                {reports.map((report) => (
                  <tr key={report.id} className="border-t border-gray-500">
