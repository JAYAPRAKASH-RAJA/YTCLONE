...
//               <button className="bg-[#242424] text-blue-500 py-2 px-4 rounded-full mt-2 absolute right-72 border border-gray-400 top-10">
...
//             </div>
//             <div className="mb-4">
//               <h2 className="text-lg mb-2">Push Notifications</h2>
//               <label className="block mb-2">
//                 <input type="checkbox" className="mr-2" />
